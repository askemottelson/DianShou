...
namespace DollarRecognizer
{
        ...
        struct SampleMultiStrokeGestures
        {
            utils util;
				...
				MultiStrokeGesture getGestureNi()
                {
					MultiStrokeGesture Multistrokes;
					/*Multistrokes.push_back(util.addPointsToMakePath(Point2D(30,100),Point2D(10,60)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(20,80),Point2D(20,10)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(50,100),Point2D(40,80)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(50,90),Point2D(100,90),Point2D(80,80)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(60,80),Point2D(60,10),Point2D(50,20)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(50,60),Point2D(40,40)));
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(70,60),Point2D(80,40)));*/
					
					Multistrokes.push_back(util.addPointsToMakePath(Point2D(30,7),Point2D(200,200), Point2D(300,100)));
